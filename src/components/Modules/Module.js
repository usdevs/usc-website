    ...
    return (
      <Container>
        <Row>
          {module && moduleTypes ? (
            <Col>
              <h4 className="mb-0 mt-4 text-primary">
                {moduleTypes[module.type].name}
              </h4>
                ...
                <Container>
                  ...
                  <Row className="mb-5">
                    {moduleReviews.length > 0 ? (
                      moduleReviews.map(moduleReview => (
                        <Col xs="12" key={moduleReview.id}>
                          <ModuleReviewCard
                            firestore={firestore}
                      ...
                      <h3 className="mt-0 mb-3">
                        ...
                        <small> No reviews are available.</small>
                      </h3>
                    )}
                  </Row>
                </Container>
            ...
            <h3 className="mt-2">
              <FontAwesomeIcon icon="spinner" spin /> Loading Module...
            </h3>
          )}
        </Row>
      </Container>
