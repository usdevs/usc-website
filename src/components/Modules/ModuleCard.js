          ...
          <Row className="d-flex align-items-center">
            <Col xs="12">
              ...
              <p>
                {fullDescription
                  ...
                  : _.truncate(description, {
                      length: hasShortDescription
                        ? config.descriptionPreviewLength
                        : config.descriptionPreviewLength / 2
                    })}
                <Button
                  onClick={() =>
              ...
              {hideButtons ? (
                ...
                <Button
                  color="primary"
                  onClick={() => history.push('/module/' + id)}
                >
                  View
                </Button>
              )}
              {hideButtons ? (
                ...
                <a
                  href={
                    (isUSP
                      ? 'http://www.usp.nus.edu.sg/curriculum/module-timetable/'
                      : 'https://nusmods.com/modules/') + code
                  }
                >
                  <Button color="secondary" className="ml-2">
                    View on {isUSP ? 'USP Website' : 'NUS Mods'}
                  </Button>
                </a>
              )}
            </Col>
