        ...
        <Container className="m-0 p-0">
          <Row className="d-flex align-items-center">
            ...
            <Col xs="9">
              ...
              {manageMode ? (
                <h4 className="mb-2">
                  <Badge color={groupStatuses[group.status].colour}>
                    {_.capitalize(group.status)}
                  </Badge>
                </h4>
              ) : (
                ''
              ...
              {manageMode &&
              !hideButtons &&
              (isLeader || ability.can('manage', 'group')) ? (
                <Button
                  outline
                  color="info"
                  className="ml-3"
                  onClick={() => history.push('/editgroup/' + id)}
                >
                  Edit
                </Button>
              ) : (
...
export default withRouter(compose(firebaseConnect())(GroupCard))
