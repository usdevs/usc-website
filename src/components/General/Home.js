          ...
          <Col sm="12">
            <Jumbotron className="pb-0 mb-0 h-100">
              ...
              <p className="lead">
                ...
                enrolled in the National University of Singapore (NUS)
                University Scholars Programme (USP), which is a
                multidisciplinary, partially residential academic programme for
                NUS undergraduates.
              </p>
              <p className="lead">
                <Button color="primary" onClick={() => history.push('/about')}>
                  Learn More
                </Button>
              </p>
              <hr className="my-2" />
                ...
                <Row>
                  ...
                  groupTypes.isLoaded ? (
                    upcomingEvents.length > 0 ? (
                      ...
                      <Col>
                        <h4>No Upcoming Events :( Stay tuned!</h4>
                      </Col>
                    )
                  ) : (
                    <Col>
