          ...
          <Container className="m-0 p-0">
            <Row>
              <Col
                ...
                className={isHorizontal ? 'd-flex align-items-center' : ''}
              >
                {displayImg ? (
                  <CardImg
                    top
              ...
              <Col xs={isHorizontal ? '9' : '12'}>
                <CardBody>
                  ...
                  <h4 className="text-muted" style={{ fontWeight: 300 }}>
                    {intlProg.usualPeriod}
                  </h4>
                  {intlProg.synopsis ? (
                    <p>
                      {fullDescription
                        ? intlProg.synopsis
                        : _.truncate(intlProg.synopsis, {
                  ...
                  {hideButtons ? (
                    ...
                    <Button
                      color="primary"
                      onClick={() => history.push('/intlProg/' + intlProg.id)}
                    >
                      Details
                    </Button>
                  )}
...
export default withRouter(compose(firebaseConnect())(IntlCard))
