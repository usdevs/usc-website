...
class IntlProg extends Component {
  ...
  showReviews() {
    ...
    _.forEach(intlProgReviews.ordered, review => {
      reviewCards.push(
        <Col key={review.id} xs="4">
          <IntlProgReviewCard intlProgReview={review} />
        </Col>
      )
    })
          ...
          <Row className="mt-3">
            ...
            <Col xs="12" md="8">
              <Container className="m-0 p-0">
                <Row>
                  <Col xs="10">
                    <h2 className="mb-0" style={{ fontWeight: 300 }}>
                      {intlProg.name}
                    </h2>
                    <h4 className="text-primary" style={{ fontWeight: 300 }}>
                      {intlProg.usualPeriod} - {intlProg.country}
                    </h4>
                  </Col>
                  <Col xs="2">
                    {flag ? (
