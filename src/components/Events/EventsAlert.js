...
const EventsAlert = props => {
  ...
  return (
    <Alert color="primary" isOpen={visible} toggle={onDismiss}>
      ...
      <div className="text-center">
      USC is hard at work to adhere to NUS' policies during the COVID-19 outbreak. All bookings made during this time on the site will not be valid. We'll be right back! For more information,
      {' '}
        <a href="https://emergency.nus.edu.sg/" className="alert-link">
          head here
        </a>
