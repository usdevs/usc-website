...
export function getModuleReview(
  firestore,
  moduleReviewID,
  callback,
  alias = 'moduleReview'
...
export function formatNUSModsModule(module) {
  const departments = {
    ...
    Dentistry: ['Dentistry', 'Division Of Graduate Dental Studies'],
  ...
  if (
    module.ModuleCode.startsWith('UWC') ||
    module.ModuleCode.startsWith('UQF') ||
    module.ModuleCode.startsWith('USS')
  ) {
